...
namespace CSharpEgitimKampi601
{
    public partial class FrmEmployee : Form
    {
        ...
        string connectionString = "Server=localhost;port=5432;Database=CustomerDb;userId=postgres;password=3438";
        ...
        void DepartmentList()
        {
            ...
            DataTable dataTable = new DataTable();
            adapter.Fill(dataTable);
            CmbEmbloyeeDepartment.DisplayMember = "DepartmentName";
            CmbEmbloyeeDepartment.ValueMember = "DepartmentId";
            CmbEmbloyeeDepartment.DataSource = dataTable;
            connection.Close ();
        }
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            int departmentId = int.Parse(CmbEmbloyeeDepartment.SelectedValue.ToString());
